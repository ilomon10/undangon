    ...
    <ThemeProvider theme={extTheme}>
      <Box sx={{ fontFamily: "serif", overflowX: "hidden" }}>
        ...
        >
          ...
          >
            <Box fontSize={2} mb={3} fontWeight="500">
              Kami mengundang Anda untuk datang di pernikahan kami
            </Box>
            <Box
              sx={{
                mb: 3,
            ...
            <Box fontSize={[3, 5]} mb={4} fontWeight={["normal", "lighter"]}>
              {contractDateFunc.format("dddd, DD MMMM YYYY")}
            </Box>
            <Box>
              <Button
                as="a"
        ...
        >
          <Fade bottom>
            <Box textAlign="center">
              <Box fontFamily="script" fontSize={4} color="accent">
                Tentang Kami
              </Box>
              <Box fontSize={[4, 5]} color="gray.6">
                Pasangan Mempelai
              </Box>
            </Box>
          </Fade>
              ...
              <Box key={i} width={["100%", "50%"]} mt={[i > 0 ? 4 : 0, 0]}>
                <Fade {...(i < 1 ? { left: true } : { right: true })}>
                  ...
                  >
                    ...
                    >
                      <Box fontSize={[3, 4]} fontFamily="script" color="accent">
                        {v.full_name}
                      </Box>
                      <Box mt={[1, 3]} fontWeight="bold">
                        {i > 1 ? "Putra" : "Putri"} dari
                      </Box>
                      <Box
                        sx={{
                          mt: [0, 2],
                  ...
                  <Fade {...(i < 1 ? { left: true } : { right: true })}>
                    ...
                    >
                      ...
                      <Box sx={{ position: "relative" }}>
                        <Box fontSize={3} fontWeight="bold" fontFamily="script">
                          {content}
                        </Box>
                        <Box mt={2} fontSize={2} fontWeight="bold">
                          {verse}
                        </Box>
                      </Box>
                    </Box>
          ...
          {[
            ...
            <Fragment key={i}>
              <Box px={3} pt={[4, 0]} width={["100%", "50%"]}>
                <Fade {...(i < 1 ? { left: true } : { right: true })}>
                  <Box fontFamily="script" fontSize={5} color="accent">
                    {v.title}
                  </Box>
                  <Flex mt={4} mx={-2}>
                    <Box width="50%" px={2}>
                  ...
                  <Box mt={3}>
                    <Box fontWeight="bold" color="gray.6">
                      Lokasi
                    </Box>
        ...
        {/* Guest Book */}
        <Box as="section" id="guest-book" sx={{ mt: 5, py: 5, bg: "black" }}>
          <Fade bottom>
            <Box textAlign="center">
              <Box fontFamily="script" fontSize={4} color="white">
                Kirimkan Pesan
              </Box>
              <Box fontSize={[4, 5]} color="gray.3">
                Untuk Kami Berdua
              </Box>
            </Box>
          </Fade>
        ...
        {music && (
          <Box textAlign="center" pt={4}>
            <AudioPlayer src={music} autoPlay controls />
          </Box>
        )}
